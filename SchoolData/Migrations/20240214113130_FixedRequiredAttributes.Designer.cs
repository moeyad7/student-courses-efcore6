...
namespace SchoolData.Migrations
{
    ...
    [Migration("20240214113130_FixedRequiredAttributes")]
    partial class FixedRequiredAttributes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolDomain.Enrollment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EnrollmentId = 1,
                            CourseId = 1,
                            EnrollmentDate = new DateTime(2024, 2, 14, 11, 31, 30, 420, DateTimeKind.Utc).AddTicks(4600),
                            StudentId = 1
                        },
                        new
                        {
                        ...
                        new
                        {
                            EnrollmentId = 3,
                            CourseId = 1,
                            EnrollmentDate = new DateTime(2024, 2, 14, 11, 31, 30, 420, DateTimeKind.Utc).AddTicks(4610),
                            StudentId = 3
                        },
                        new
                        {
